...
- 2026-07-13: Added a persisted "电脑端布局" display flag. Default mobile behavior remains responsive drawer/single-column layout; enabling the flag forces desktop layout structure only.
