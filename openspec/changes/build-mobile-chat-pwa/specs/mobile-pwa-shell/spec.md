...
The system SHALL reserve a settings surface for API profiles, chat and utility assistants, context-compaction rules, diagnostics and debug mode, data portability, appearance, composer input behavior, and future application options.
