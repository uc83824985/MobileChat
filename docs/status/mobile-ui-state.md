...
- A persisted "电脑端布局" display setting can force the desktop layout structure on narrow screens. This is a layout-only flag and does not change conversation state, local persistence, request construction, or provider protocol behavior.
